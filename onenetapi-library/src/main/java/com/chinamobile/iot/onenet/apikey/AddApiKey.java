...
public class AddApiKey extends BaseStringRequest {
    ...
    public AddApiKey(String masterKey, String title, String deviceId, String datastreamId, ResponseListener listener) {
        super(Method.POST, URL, masterKey, listener);
        mTitle = title;
        mDeviceId = deviceId;
