...
public class IntentActions {
    ...
    public static final String ACTION_UPDATE_DEVICE = "com.chinamobile.iot.onenet.sdksample.intent.ACTION_UPDATE_DEVICE";
    public static final String ACTION_UPDATE_DS_LIST = "com.chinamobile.iot.onenet.sdksample.intent.ACTION_UPDATE_DS_LIST";
